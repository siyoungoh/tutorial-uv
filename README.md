...
- 자세한 명령어 설명은 [instruction.md](docs/instruction.md)를 참고하세요.
...
- 상세 트러블슈팅은 [instruction.md](docs/instruction.md)의 "자주 발생하는 에러 + 해결법" 섹션을 참고하세요.
...
- 상세 해석은 [instruction.md](docs/instruction.md)의 "복붙 진단 명령 모음" 섹션을 참고하세요.
